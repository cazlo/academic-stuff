...
/*******************************************************************************************************************/
    private int redCount=0, blackCount=0;
    public void countNodes(){
        countNodesInOrder(header.right);
        System.out.println("Red nodes: " + redCount);
        System.out.println("Black Nodes: " + blackCount);
    }
    
    private void countNodesInOrder (RedBlackNode<AnyType> node){
        if (node != nullNode){
            countNodesInOrder(node.left);
